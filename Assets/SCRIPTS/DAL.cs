...
namespace DataAccessLayer
{
    public class DAL
    {
        ...
        public DAL()
        {
            _SqlConn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Carmen.Tiba\Documents\database_survival.mdf;Integrated Security=True;Connect Timeout=30");
        }
